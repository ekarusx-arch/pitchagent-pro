...
export function Sidebar({ activeTab, setActiveTab, profile, handleSignOut }: SidebarProps) {
    ...
    return (
        <aside className="w-80 h-[calc(100vh-2rem)] sticky top-4 flex flex-col bg-slate-950/40 backdrop-blur-2xl border border-white/10 rounded-[32px] p-8 shadow-2xl relative overflow-hidden group">
            {/* Background Accent */}
