...
export default function DashboardPage() {
        ...
        try {
            ...
            if ((window as any).Paddle) {
                (window as any).Paddle.Checkout.open({
                    ...
                    customData: data.customData || { userId: user.id, credits: options.credits?.toString() }
                });
            }
        } catch (error) {
    ...
    const handleDownloadPDF = async (itemResult?: { pitch: string; insights: string[] }) => {
        ...
        try {
            ...
            doc.text("PitchAgent Pro — Strategic Resource", margin, 9);
    ...
    return (
        <main className="min-h-screen bg-slate-950 text-slate-200 selection:bg-primary/30 flex p-4 gap-8">
            <Sidebar
                activeTab={activeTab}
            ...
            <div className="flex-1 max-h-[calc(100vh-2rem)] overflow-y-auto custom-scrollbar pr-4 pt-4">
